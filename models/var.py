...
class VAR(nn.Module):
    ...
    def autoregressive_infer_cfg(
        self, input_img: torch.Tensor, g_seed: Optional[int] = None, top_k=0, top_p=0.0, more_smooth=False,
    ...
    def forward(self, x_BLCv_wo_first_l: torch.Tensor, input_img: torch.Tensor) -> torch.Tensor:  # returns logits_BLV
        """
